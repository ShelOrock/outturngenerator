...
export const marchCasks: CaskAttributes[] = [
  ...
  },
  {
    ...
    caskNumber: '41.139',
    price: '115',
    flavorProfile: 'Juicy, oak & vanilla',
    age: '12',
    date: 'April 2008',
    ...
    bottleCount: '190',
    allocation: '60',
    description: 'The complex nose held juicy pineapple and watermelon; vanilla fudge and puff candy; then thyme and sage in a potting shed. The palate’s main thrust delivered honey, Danish pastries, mango pudding with custard, Starburst and Skittles – the finish had clean oak, lemon peel and white pepper. The reduced nose returned to a fruity dimension – stewed apples, ripe pears and lime flavored fondant sweets – other comments included wildflowers, rosewater, gorse and hawthorn; candied angelica on sponge cake and vending machine gumballs. The palate tasted older than the stated age – juniper, limoncello, gewürztraminer and perfumed cigarettes; spearmint Softmints, oak and vanilla.'
  },
  {
    name: 'Members remember embers',
    caskNumber: '93.151',
    price: '130',
    flavorProfile: 'Lightly Peated',
    age: '10',
    date: 'March 2010',
    region: 'Campbeltown',
    caskType: 'First-fill barrel',
  ...
  },
  {
    ...
    bottleCount: '235',
    allocation: '102',
    description: 'A cosy blanket of wool wrapped around bitter lemon, black grapes and tangerines as dried chamomile petals mixed with dark chocolate and lots of vanilla. Then on the palette came a burst of orange fruit from funky Amarillo hops that morphed into lime zest while dark chocolate remained with cinnamon, ginger and mace spice. A dash of water heralded an explosion of citrus fruit cascading over lemon drizzle cake in a pine forest. Earthy notes of herb gardens mirrored dried hops with bitter marmalade as the flavors now veered us towards bananas on burnt toast with cinnamon and persistent chocolate. After spending nine years in an ex-bourbon barrel this was transferred to an ex-Tempest Old Fashioned IPA cask for the remainder of its maturation.'
  },
  {
    name: 'Royal nonsense?',
    caskNumber: '72.97',
  ...
  },
  {
    ...
    caskNumber: '9.191',
    price: '175',
    flavorProfile: 'Sweet, fruity & mellow',
    age: '17',
    date: 'September 2003',
    region: 'Speyside Spey',
    caskType: 'First-fill barrel',
...
export const marchMidMonthCasks: CaskAttributes[] = [
  ...
  },
  {
    ...
    caskNumber: '37.132',
    price: '190',
    flavorProfile: 'Deep, rich & dried fruits',
    age: '18',
    date: 'June 2002',
    region: 'Speyside Spey',
  ...
  },
  {
    ...
    bottleCount: '199',
    allocation: '60',
    description: 'A rich profusion of delights embraced smoky bacon and honey with roasted chestnuts and toasted pine nuts on a bed of warm cereals and roasted sweet potato. Medicinal notes danced around a central mound of ash and charcoal as treacle drizzled down from above. Then fruity notes emerged that combined baked pineapple with orange skin and lemon drizzle cake. Water shifted the focus towards medicinal and coastal flavors as clean bandages lay strewn over seaweed and rock pools. Roast vegetables now appeared from the oven, glazed with honey, tarragon and thyme. Hints of pipe tobacco, liquorice and nutmeg merged on a finish that was dry, clean and laden with sea salt.'
  },
  {
    name: 'Fragrant, fresh and green',
    caskNumber: '26.152',
    price: '115',
    flavorProfile: 'Young & spritely',
    age: '8',
    date: 'September 2011',
...
export const aprilCasks: CaskAttributes[] = [
  ...
  },
  {
    ...
    bottleCount: '196',
    allocation: '84',
    description: "A subtle tropical and floral scent, like walking through a rose garden, mesmerized us. To taste a sense of spicy oak before a burst of juicy fruity flavors surprised us all. With a drop of water wax candles and veneered oak at first were soon followed by chilled caramelised orange slices with Greek yoghurt. On the palate now a summer delight with a difference; sweet succulent cherries with Neufchatel cheese sprinkled with Mexican cocoa powder; containing cinnamon and vanilla served with a thin, crisp chocolate cookie. After thirteen years in a 2nd fill bourbon barrel, we transferred this whisky into a 1st fill barrique from a privately owned small bodega, now in its 9th generation, that focuses exclusively on the Pedro Ximenez grape."
  },
  {
  ...
  },
  {
    ...
    bottleCount: '260',
    allocation: '90',
    description: "A sticky combination of marmalade, honey and sugar syrup coated coconut and dark chocolate as citrus oils were released from orange and physalis. On the palate came a rush of orange vitamin pills and lime zest but now with toasty cereal notes, butter pastry and spicy cassia bark. Water lifted the aromas to release vanilla and apples along with soft fudge and strawberry laces. Orange now merged with buttered crumpets and the riper character of blood oranges found a sweet and spicy palate. Finally, flavors swirled lemons and limes around the mouth with caramel wafers and hints of wood char and cloves on the finish."
  },
  {
...
export const highlandFestivalCasks: CaskAttributes[] = [
  ...
  },
  {
    ...
    bottleCount: '236',
    allocation: '120',
    description: "We all looked at each other and nodded, yes there is a hint of smoke – not much but noteworthy, maybe like a wax jacket which hung in a room with a burning peat fire. On the palate - delicious hot-smoked salmon and parsley fishcakes with a zingy lemon mayonnaise dip. After a drop of water, the aroma was even more mouth-watering - smoky grilled shrimps in a Marie Rose sauce and to taste; bananas flambeed Caribbean style using butter along with dark-brown sugar, dark rum and lime juice. The smooth finish had plenty of refreshingly lemony flavors with a gentle herbal note."
  },
  {
...
export const islayFestivalCasks: CaskAttributes[] = [
  ...
  },
  {
    ...
    bottleCount: '265',
    allocation: '265',
    description: "Our noses twitched at the peat smoke, white pepper, Sudocrem and muscle rub, before discovering a green tapestry of smoky stewed spinach, moss on a dyke, seaweed sorbet, olives in brine and bread dipped in moules marinieres liquor. The palate was equally smoky, but somehow cleaner, even elegant – poached pears, oysters, pickled cucumber, sea-salt sherbet, thyme, samphire and smoked mackerel. New aromas on the reduced nose were cut grass, pea shoots, lime and eucalyptus; peanuts in shells, toasted sesame seeds, popcorn and swimming pools. The reduced palate remained substantially textured, with flavors of salted caramel, liquorice, pine sap and mint humbugs."
  },
];
...
export const juneOutturnCasks: CaskAttributes[] = [
  ...
  },
  {
    ...
    bottleCount: '224',
    allocation: '90',
    description: "Soft fruits swirled around dried banana, mango and dragon fruit as a little limey zing summoned peppermint, cloves and cardamom pods. flavors transcended the conscious realms as heather blossom and agave syrup joined fragrant Indian spices over charred pineapple and mango coulis. Water brought us to a place of inner content with an abundance of juicy fruit, marshmallows and lemon meringue pie. Vanilla slices joined soft buttery notes and strawberry milkshake as ripe melon brought a sense of mellow around perfumed sandalwood, cinnamon and toffee. Divine flavors of honey and fudge lasted well onto the finish as this gentle nature demanded careful use of water."
  },
  {
